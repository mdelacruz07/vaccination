                ...
                <form id ="create_form" enctype="multipart/form-data">
                    <div class="modal-body p-2 m-0" style=" height: 70vh;  overflow-y: auto;" >
                        ...
                        <div class="card" style="background-color:rgb(237, 240, 238)">
                            <div class="col-12 row pr-3 pl-3">
                                ...
                                <div class="form-group col-sm-3">
                                    ...
                                    <input type="date" class="form-control regis_form  bg-info" name="bday">
                                </div>
                                ...
                                <h6 class="col-12"><center><b>Consent</b></center></h6>
                        ...
                        <div class="card" style="background-color:rgb(239, 240, 206)">
                            <div class="col-12 row  pr-3 pl-3">
                                <center class="col-12"><h4><u>Vaccination</u></h4></center>
                                ...
                                <div class="col-12 row"><!-- Vaccination: -->
                                    ...
                                    <div class="form-group col-sm-3">
                                        <input type="date" class="form-control regis_form  bg-info" name="date_of_vaccination" >
