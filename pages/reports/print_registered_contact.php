<?php
    ...
    // $bago_barangay_array = $_POST["bago_barangay_array"];
    $category = $_POST["category"];

    $bago_barangay_array = explode(",", $bago_barangay_array);
    $category = explode(",", $category);

    // print_r($bago_barangay_array); echo "<br>";
        ...
        foreach($category as $cat){
          ...
          $SelectR = $systemcore->SelectCustomize("SELECT * FROM vaccine_registration ORDER BY date_added ASC");
            foreach($SelectR as $value){ $x++; 
              ...
              $month_cancel = explode("-",$date_added);
              $month_cancel = $month_cancel[1];
              
              if($value["brgy"] == $brgy && $value["employmentcategory"] == $cat && $value["dose_1"] != "01_Yes" && $value["dose_2"] != "01_Yes" && $month_cancel !="05"){      
            ...
            <h2 class="page-header row">
              ...
              <div class="col-sm-12">
                ...
                <div class="col-6 text-center offset-3">
                  <b style="font-size:22px;">List of Profiled and None Vaccinated</b><br>
                ...
                <div class="col-3 text-left">
                      <p style="font-size:14px;" class="p-0 m-0">Vaccine Name: <b>None</b></p>
                      <p style="font-size:14px;" class="p-0 m-0">Monthly Report of: <b><?php echo date("F");?></b></p>
                      <p style="font-size:14px;" class="p-0 m-0">1st Dose: <b>No</b></p>
                      <p style="font-size:14px;" class="p-0 m-0">2nd Dose: <b>No</b></p>
                </div>
            </h2>
    ...
    <div class="col-12 asdasdasd">
            <h2 class="page-header row">
              ...
              <div class="col-sm-12" >
                  ...
                  <u style="font-size:20px;">Vaccine Information Management System</u></p>
                  <!-- <b style="font-size:22px;">Registered Contact List Information</b><br> -->
                  <b style="font-size:22px;">Profiled and None Vaccinated Report</b><br>
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-6 invoice-col row">
                    ...
                    <div class="col-6">
                      <h6 class="p-1" style="background-color: rgb(241, 255, 102)"><u>Profiled and None Vaccinated Report</u></h6>
                    </div>
