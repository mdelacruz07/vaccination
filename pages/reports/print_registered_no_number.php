          ...
          <div class="col-12 asdasdasd">
            <h2 class="page-header row">
              ...
              <div class="col-sm-12" >
                  ...
                  <b style="font-size:22px;">Profiled, None Vaccinated and Vaccinated Report(With No Mobile Number)</b><br>
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-6 invoice-col row">
                    ...
                    <div class="col-6">
                      <h6><u>List of Profiled and None Vaccinated</u></h6>
                    </div>
        ...
        foreach($category as $cat){
          ...
          $SelectR = $systemcore->SelectCustomize("SELECT * FROM vaccine_registration");
            foreach($SelectR as $value){ $x++; 
              ...
              if($value["brgy"] == $brgy && $value["employmentcategory"] == $cat && $value["dose_1"] != "01_Yes" && $contact_first_2_digit != "09" && $contact_length != 11 && $contact_length != 23 && $contact_first_2_digit != "+6"){ $error++; }
            ...
            <table class="table table-hover">
              ...
              <?php
                ...
                foreach($SelectR as $value){ $x++; 
                  ...
                  if($value["brgy"] == $brgy && $value["employmentcategory"] == $cat && $value["dose_1"] != "01_Yes" && $contact_first_2_digit != "09" && $contact_length != 11 && $contact_length != 23 && $contact_first_2_digit != "+6"){ $total_counter++; 
                  ...
                  <tr>
                    ...
                    <td><p class="col-12 bg-warning"><?php echo $contact;?></p></td>
