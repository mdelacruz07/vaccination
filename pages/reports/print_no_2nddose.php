  ...
  <div class="col-1 offset-11 pr-3"> <button class="btn btn-outline-info col-12" id="printPageButton" onclick="Printer()">Print</button></div>
      ...
      foreach($bago_barangay_array as $brgy){ 
        foreach($category as $cat){
          $error = false;
          $SelectR = $systemcore->SelectCustomize("SELECT * FROM vaccine_registration WHERE dose_1 = '01_Yes' AND dose_2 != '01_Yes' AND vaccine_name = '$vaccine_name' ORDER BY lastname ASC");
            foreach($SelectR as $value){ $x++; 
              ...
              if($value["brgy"] == $brgy && $value["employmentcategory"] == $cat && $month_of_vaccination == $report_month_vaccination){ 
          ...
          <div class="col-12 asdasdasd">
            <h2 class="page-header row">
                    ...
                    <div class="col-6 text-center offset-3">
                          <b style="font-size:22px;">Monthly List of Vaccinated With No Second Dose</b><br>
                    ...
                    <div class="col-3 text-left">
                          ...
                          <p style="font-size:14px;" class="p-0 m-0">Monthly Report of: <b><?php echo $month_name_report_2;?></b></p>
                          <p style="font-size:14px;" class="p-0 m-0">Date of 1st Dose: <b><?php echo $month_name_report;?></b></p>
                          <p style="font-size:14px;" class="p-0 m-0">Date of 2nd Dose: <b><?php echo $month_name_report_2;?></b></p>
                    </div>
            </h2>
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-6 invoice-col row">
                    ...
                    <div class="col-6">
                      <h6 class="p-1" style="background-color: rgb(241, 255, 102)"><u>Monthly List of Vaccinated With No Second Dose</u></h6>
                    </div>
                    ...
                    <div class="col-6">
                      <h6 class="p-1" style="background-color: rgb(241, 255, 102)"><u><?php echo $month_name_report_2; ?></u></h6>
                    </div>
