  ...
  <!-- <div class="content-wrapper"> -->
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>VIMS Mobile Encoder</h1>
            <p><?php echo $_SESSION["user_full_name"];?></b></p>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                ...
                <div class="form-group col-sm-12">
                    ...
                    <form class="input-group mb-3">
                        ...
                        <div class="input-group-prepend col-2">
                            <button type="button" class="btn btn-warning col-12" onclick="show_table('registrants_table', 'show_registered_mobile', '#example1', search_keyword.value)"><i class="fas fa-search"></i></button>
                        </div>
                    </form>
                </div>
                <div id="registrants_table">
        ...
        <div class="modal-dialog modal-xl" style="overflow-y: initial !important">
            <div class="modal-content">
                ...
                <div class="modal-footer p-1 justify-content-between">
                    ...
                    <button type="submit" onclick="set_system_cardinal_operation('You want to Create this new Registrant?', 'create', 'create_form', 'create.php', 'registrants_table', 'show_registered_mobile', '#example1', 'required_div', 'confirmation_create_success', 'create_user')" class="btn btn-primary">Submit</button>                           
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
