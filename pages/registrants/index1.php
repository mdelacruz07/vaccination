                        ...
                        <div class="card" style="background-color:rgb(239, 240, 206)">
                            <div class="col-12 row  pr-3 pl-3">
                                ...
                                <div class="col-12 row"><!-- Vaccination: -->
                                    ...
                                    <div class="form-group col-sm-3">
                                        <input type="date" class="form-control regis_form  bg-info" name="date_of_vaccination" alt="required" value="<?php echo date('Y-m-d'); ?>">
                                        <label for="exampleInputEmail1">Date of Vaccination 1st Dose?<span style="color:red;">*</span><span style="color:gray; font-size:14px">(Petsa ng Pagbabakuna?)</span></label>
                                    </div>
                                    ...
                                    <div class="form-group col-sm-3">
                                        <input type="text" class="form-control regis_form" name="lot_number" value="<?php echo $batch_number; ?>" >
                                        <label for="exampleInputEmail1">Lot Number?<span style="color:red;">*</span></label>
                                    </div>

                                    <div class="form-group col-sm-4">
                                        <input type="text" class="form-control regis_form" name="vaccinator_name" value="<?php echo $vaccinator; ?>" >
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <option value="<?php echo $Dose_1_value; ?>" ><?php echo $Dose_1_value; ?></option>
                                            <option value="01_Yes">Yes</option>
                                            <option value="02_No">No</option>
                                        </select>
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <option value="<?php echo $Dose_2_value; ?>" ><?php echo $Dose_2_value; ?></option>
                                            <option value="01_Yes">Yes</option>
                                            <option value="02_No">No</option>
                                        </select>
