<?php
    ...
    // 2nd vaccine
    $sec_vaccine_name = $_GET["sec_vaccine_name"]; 
    $sec_batch_number = $_GET["sec_batch_number"]; 
    $sec_lot_number = $_GET["sec_lot_number"]; 
    $sec_time_stamp = $_GET["sec_date_of_vaccination"]; 
    ...
    `sec_vaccine_name`='$sec_vaccine_name',
    `sec_batch_number`='$sec_batch_number',
    `sec_lot_number`='$sec_lot_number',
    `sec_date_of_vaccination`='$sec_time_stamp'";
