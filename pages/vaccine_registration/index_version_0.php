        ...
        <form id="survey_form" method="post">
          <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
              ...
              <div class="row">
                <div class="form-group col-sm-6">
                  ...
                  <select name="employmentcategory" class="form-control regis_form" alt="required" required onclick="select_conditional('sub_category1', this.value, 'array', 'array', 'array', 'select_sub_category_by_category', 'array')">
                ...
                <div class="form-group col-sm-6">
                  ...
                  <select name="idcategory" class="form-control regis_form" required>
                    <option value="Empty" hidden></option>
                ...
                <div class="form-group col-sm-6">
                  ...
                  <input type="text" class="form-control regis_form" name="idnumber" alt="required" value="">
                </div>
                ...
                <div class="form-group col-sm-12">
                  <label required for="exampleInputEmail1">Current Residence:<span style="color:red;">*</span><span style="color:gray; font-size:14px">(Kasalukuyang Tirahan)</span></span><span style="color:gray; font-size:12px">(Unit/Building/House_Number,_Street_Name)</span></label>
                ...
                <div class="form-group col-sm-6">
                  ...
                  <select name="employmentcategory" class="form-control regis_form" alt="required" required onclick="select_conditional('sub_category1', this.value, 'array', 'array', 'array', 'select_province', 'array')">
                    <option value="Empty" hidden></option>
                    <?php foreach($Global_category_array as $data){   ?>
                      <option value="<?php echo $data; ?>"><?php echo $data; ?></option>
                    <?php } ?>
                ...
                <div class="form-group col-sm-6">
                  ...
                  <select name="employmentcategory" class="form-control regis_form" alt="required" required onclick="select_conditional('sub_category1', this.value, 'array', 'array', 'array', 'select_city', 'array')">
                ...
                <div class="form-group col-sm-6">
                  ...
                  <select name="employmentcategory" class="form-control regis_form" alt="required" required onclick="select_conditional('sub_category1', this.value, 'array', 'array', 'array', 'select_brgy', 'array')">
                ...
                <div class="form-group col-sm-6">
                  <label required for="exampleInputEmail1">Mobile Number<span style="color:red;">*</span><span style="color:gray; font-size:14px">(Numero)</span></span><span style="color:gray; font-size:10px">(09XXXXXXXXX)</span></label>
                  <input type="text" class="form-control regis_form" alt="required"  name="contact" >
                </div>

                <!-- <div class="form-group col-sm-6">
                  <label for="exampleInputEmail1">Barangay<span style="color:red;">*</span></label>
                  <select name="brgy" class="form-control regis_form" alt="required" required>
                    <option value="Empty" hidden></option>
                ...
                <div class="form-group col-sm-6">
                  ...
                  <input type="date" class="form-control regis_form" name="bday" alt="required" required oninput="select_conditional('select_vaccine', this.value, 'system_vaccines', 'none1', 'none1', 'select_vaccine_by_age', 'none1')">
                </div>
                <div class="form-group col-sm-12">
              ...
              <div class="row pt-2 pb-2" style="border-bottom:1px solid gray">
                <div class="col-6">
                  <label for="exampleInputEmail1">Allergy sa PEG or sa Polysorbate<span style="color:red;">*</span><br><span style="color:gray; font-size:14px">(Glycol Allergy)</span></label>
                  <input type="text" class="form-control" name="PEG_alergy" value="NO" id="PEG_alergy" hidden>
                </div>
                <div class="col-6 row">
            ...
            <div class="tab-pane fade show active" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
              <center><h4><u>Vaccination Schedule</u></h4>
              <p>Pumili ng petsa at pasilidad kong saan mo gusto mag pa bakuna<br></center>

              <div class="form-group col-sm-12">
                <label for="exampleInputEmail1">Vaccination Facility<span style="color:red;">*</span><span style="color:gray; font-size:14px">(Pasilidad para sa pagbabakuna, Ang mga sumusunod na pasilidad ay batay sa aktibong pasilidad ng City Health Office)</span></label>
                <select name="vaccination_facility" class="form-control" alt="required" required onchange="select_conditional('schedule_select', this.value, 'system_schedule', 'system_schedule.facility_id', 'schedule_name', 'COMPARE_ID', 'online_registrationococAlloc'+selected_vaccine.value)">  
              ...
              <div class="form-group col-sm-12">
                <label for="exampleInputEmail1">Vaccine<span style="color:red;">*</span><span style="color:gray; font-size:14px">(Bakuna, Ang mga sumusunod na mga bakuna ay batay sa pinili ng City Health Office)</span></label>
                <select id="select_vaccine" name="selected_vaccine" class="form-control" required alt="required" onchange="select_conditional('schedule_select', vaccination_facility.value, 'system_schedule', 'system_schedule.facility_id', 'schedule_name', 'COMPARE_ID', 'online_registrationococAlloc'+this.value)">  
                    <option value="Empty" hidden></option><?php
                    
                    $SelectGroups = $systemcore->SelectTable("system_vaccines WHERE id != '1'");
                    foreach($SelectGroups as $value){  
                        
                        if($value['id'] == "1"){
                          $vaccine_name = "Any Vaccine";
                        }else{
                          $vaccine_name = $value['vaccine_name'];
                        }
                        echo "<option value='".$value['id']."'>".$vaccine_name."</option>";

                  }?>
                </select>
              </div>
              <input type="text" name="schedule_id" id="schedule_id" alt="required" hidden>
              <div class="alert alert-danger alert-dismissible fade show" id="schedule_select_alert" role="alert" style="display:none;">
                <strong>Paalala!</strong> Mangyaring pumili ng iskedyul sa ibaba para sa iyong pagbabakuna!
                <button type="button" class="close" onclick="turn_off_required('schedule_select_alert')" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
              </div> 
    ...
    if(operation == "create" || operation == "update" || operation == "delete"){
        for ( var i = 0; i < form.elements.length; i++ ) {
            ...
            if(e.type != 'radio'){
              ...
              document.getElementById("schedule_select").style.borderColor = "gray";
              document.getElementById("schedule_select").style["boxShadow"] = "none";
              ...
              if(element_alt == "required"){
                  if(element_value == ""){
                      ...
                      if(element_name == "schedule_id"){//this is for the schedule only
                        document.getElementById("schedule_select").style.borderColor = "red";
                        document.getElementById("schedule_select").style["boxShadow"] = "0 0 5px #f20a0a";
                        document.getElementById("schedule_select_alert").style.display = "block";// if error display error for required inputs
                      }
                  } 
              }
              if(e.required == true){
