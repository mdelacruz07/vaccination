...
<body class="pages_body">
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h2 class="card-title col-lg-10" style="padding-top:10px; "><b>List Of Suppliers</b></h2>

              <button type="button" class="btn btn-block btn-outline-secondary col-lg-2" data-toggle="modal" data-target="#create_supplier">Add New Supplier</button>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
  ...
  <!-- /.content-wrapper -->
    ...
    <div class="modal fade" id="create_supplier">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                            ...
                            <div class="row col-sm-12">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control float-right" name="contact_person" alt="required">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="tel" class="form-control float-right supplier_phone" name="phone" maxlength="11" alt="required">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control float-right" name="email" alt="required">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control float-right" name="address" rows="3"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="submit" onclick="set_system_cardinal_operation('You want to Add this new Supplier?', 'create', 'create_form', 'create_supplier.php', 'supplier_table', 'vaccine_supplier', '#tbl_suppliers', 'required_div', 'confirmation_create_success', 'create_supplier')" class="btn btn-primary">Submit</button>                           
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        show_table("supplier_table", "vaccine_supplier", "#tbl_suppliers");
