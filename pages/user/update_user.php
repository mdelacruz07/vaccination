<?php
    ...
    $table = "system_user";
    $col_to_update = "first_name='$first_name', middle_name='$middle_name', last_name='$last_name', birthday='$birthday', gender='$gender', address='$address', contact='$contact', suffix='$suffix', username='$username', password='$password', access='$access', profile_picture='$profile_picture'";
