...
<html>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if($SelectTable == "none"){ ?>
          ...
          if($value['password'] !=  md5($login_password)){
            ...
            // }else{
              echo "<script> location.replace('../registrants/mobile_encoder.php'); </script>";
            // }
          }
        }
      }
  ...
  <body class="hold-transition login-page login-background">
    <div class="login-box" style="background-color: rgba(255, 255, 255, 0.5); border-radius: 25px; padding:20px;">
