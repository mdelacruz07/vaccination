...
<body style="background-color:rgb(227, 225, 218); color:black; margin-left:20px;">
  <!-- Content Wrapper. Contains page content -->
    ...
    $SelectGroups = $systemcore->DeleteTable("vims_vas_13", "R = 'N/A'");
    $SelectTable = $systemcore->SelectCustomize("SELECT * FROM vaccine_registration WHERE time_stamp = '2021-6-15'");
    ...
    foreach($SelectTable as $data){ 
      ...
      $table_val = "'$Category', '$qr_id', '$pwd', '$indigenous', '$lastname', '$firstname', '$middlename', '$suffix', '$contact', '$region1', '$province', '$city', '$brgy', '$gender', '$bday', '$defferal', '$reason_for_deferral', '$time_stamp', '$vaccine_name', '$batch_number', '$lot_number', 'CBC04042', '$vaccinator_name', '$dose_1', '$dose_2', '$adverse_event', '$adverse_event_cons'"; 
