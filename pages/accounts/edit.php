    ...
    foreach($SelectTable as $value){
        ...
        $code_gen = $value['code'];
        $code_gen_link = "bagocho.pagenet.info/OVRM/pages/scan_code/index.php?id=".$code_gen;
            ...
            <div class="row col-sm-4">
                <div class="form-group col-lg-12">
                    <div class="col-lg-12 text-center profile_shell" style="padding-top:50px">
                        <img width="200px" src="generate.php?text=<?php echo $code_gen_link;?>" alt="">
                    </div>
                </div>
                <a class="col-sm-12 text-center" href="generate.php?text=<?php echo $code_gen_link;?>" download="My_CHO_Login_QRCODE">
                    <button type="button" class="btn btn-success col-sm-8">Download QR Code</button>
                </a>
                <input type="file" class="custom-file-input" name="profile" id="exampleInputFile" hidden>
            </div>
            ...
            <div class="row col-sm-8">
                ...
                <div class="form-group col-lg-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control float-right" id="facility_id" value="<?php echo $facility_id;?>" name="facility_id">
                    </div>
                </div>
...
<div class="modal-footer justify-content-between">
    ...
    <button type="submit" onclick="set_system_cardinal_operation('You want to Update this Account?', 'update', 'update_form', 'update_user.php', 'update_result', 'none', 'none', 'required_div', 'confirmation_update_success', 'none')" class="btn btn-primary">Update</button>                           
</div>