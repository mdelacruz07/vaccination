      ...
      <form class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-2">
            ...
            <button class="btn btn-warning col-12" type="button" id="printPageButton" onclick="sys_edit('vims_allocation.php', 'allocation', selected_date.value, 'required_div', '#example1')">Generate Vims-IR Allocation</button>
          </div>
        </div>
